...
public class MainController {
	...
	public String query3() {
		List<User1VO> users = repo.findUser1VOByNameNot("김현준");
	...
	public String query4() {
		List<User1VO> users = repo.findUser1VOByUidAndName("et002727", "김현준");
	...
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("a101", "김춘추");
	...
	public String query6() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThan(21);
	...
	public String query7() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanEqual(30);
	...
	public String query9() {
		List<User1VO> users = repo.findUser1VOByAgeLessThanEqual(26);
	...
	public String query10() {
		List<User1VO> users = repo.findUser1VOByNameLike("%현준%");
	...
	public String query11() {
		List<User1VO> users = repo.findUser1VOByNameContains("현");
	...
	public String query13() {
		List<User1VO> users = repo.findUser1VOByNameEndsWith("준");
	...
	public String query18() {
		int countUid = repo.countUser1VOByUid("a101");
		System.out.println("query18 결과 : " + countUid);
		return "redirect:/";
	}
	
	@GetMapping("/query19")
	public String query19() {
		int countName = repo.countUser1VOByName("김현준");
		System.out.println("query19 결과 : " + countName);
		return "redirect:/";
	}
	...
	public String query21() {
		List<User1VO> users = repo.selectUserByName("김현준");
